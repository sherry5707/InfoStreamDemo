...
import com.ragentek.infostreamdemo.adapter.DragAdapter;
import com.ragentek.infostreamdemo.adapter.OtherAdapter;
import com.ragentek.infostreamdemo.bean.ChannelItem;
import com.ragentek.infostreamdemo.bean.ChannelManage;
import com.ragentek.infostreamdemo.view.DragGrid;
import com.ragentek.infostreamdemo.view.OtherGridView;
...
public class ChannelActivity extends Activity implements OnItemClickListener {
	...
	private LinearLayout close;		//关闭图标
...
*/		    window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
		    window.setStatusBarColor(getResources().getColor(R.color.subscribe_activity_bg));
		} 
	...
	private void initView() {
		...
		close=(LinearLayout)findViewById(R.id.close_layout);
